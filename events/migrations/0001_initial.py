    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bowling_centers', models.ManyToManyField(related_name='%(class)s_bowling_centers', to='events.bowlingcenter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bowler', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='league_bowlers', to='profiles.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bowler', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bowler_scores', to='events.rosterentry')),
            ],
            options={
