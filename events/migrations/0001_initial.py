        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'owner',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='owned_events', to='profiles.profile'
                    ),
                ),
                (
                    'polymorphic_ctype',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'event',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='rosters', to='events.event'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'roster',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='roster_entries', to='events.roster'
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='bowler_sidepot_entries',
                        to='events.rosterentry',
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=6, validators=[django.core.validators.MinValueValidator(2)]
                    ),
                ),
                ...
                (
                    'event',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='sidepots', to='events.event'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'bowler',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='game_scores', to='events.rosterentry'
                    ),
                ),
            ],
            options={
